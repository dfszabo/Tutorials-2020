...
int main(int argc, char **argv) {
  ...
  while (ros::ok()) {
      ...
      left_back_leg_2.publish(position_msg);
  left_mid_leg_2.publish(position_msg);
  left_front_leg_2.publish(position_msg);
  //right_back_leg_2.publish(position_msg);
  //right_mid_leg_2.publish(position_msg);
  //right_front_leg_2.publish(position_msg);
  }
